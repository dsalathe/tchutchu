...
public final class SortedBag<E extends Comparable<E>> implements Iterable<E> {
    ...
    public static <E extends Comparable<E>> SortedBag<E> of(int n1, E e1, int n2, E e2) {
        ...
        TreeMap<E, Integer> elements = new TreeMap<E, Integer>();
    ...
    public E get(int index) {
        ...
        for (Map.Entry<E, Integer> elementsAndCount : elements.entrySet()) {
            Integer count = elementsAndCount.getValue();
            if (index < count)
    ...
    public SortedBag<E> union(SortedBag<E> that) {
        TreeMap<E, Integer> newElements = new TreeMap<>(elements);
    ...
    public Set<SortedBag<E>> subsetsOfSize(int size) {
        ...
        Set<SortedBag<E>> result = new HashSet<SortedBag<E>>();
        for (E e1 : elements.keySet()) {
            SortedBag<E> s1 = SortedBag.of(e1);
            this.difference(s1)
    ...
    public Stream<E> stream() {
        ...
        elements.forEach((v, n) -> { for (int i = 0; i < n; i++) builder.add(v); });
        return builder.build();
    }
