error id: file://<WORKSPACE>/src/main/java/ch/coachdave/tchutchu/gui/Info.java:_empty_/`<any>`#trim#
file://<WORKSPACE>/src/main/java/ch/coachdave/tchutchu/gui/Info.java
empty definition using pc, found symbol in pc: _empty_/`<any>`#trim#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 1365
uri: file://<WORKSPACE>/src/main/java/ch/coachdave/tchutchu/gui/Info.java
text:
```scala
